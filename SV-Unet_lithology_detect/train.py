...
from unet_utils.callbacks import EvalCallback, LossHistory
from unet_utils.dataloader import UnetDataset, unet_dataset_collate
from unet_utils.utils import (download_weights, seed_everything, show_config,
                         worker_init_fn)
from unet_utils.utils_fit import fit_one_epoch
...
if __name__ == "__main__":
    ...
    with open(os.path.join(VOCdevkit_path, "VOC2007/ImageSets/Segmentation/val1.txt"),"r") as f:
